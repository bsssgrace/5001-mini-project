...
![image](https://github.com/bsssgrace/5001-mini-project/assets/117662533/bbb89762-1753-4abc-a80e-514389032ba9)
  ...
  จากสถานะการณ์Covid-19 ที่เป็นโรคภัยระบาดครั้งใหญ่ของโลก เป็นภัยพิบัติที่ทำให้เกิดความวิตกกังวลอย่างมากต่อชีวิตของคนทั่วโลตั้งแต่ปี2020 ยาวมาถึงปัจจุบัน จากกราฟเราแบ่งTimeline เราแบ่งช่วงของสถาณการณ์เป็น5ช่วงหลักๆ 1. 2. 3. 4. 5. พร้อมแสดงจำนวนของผู้ติดเชื้อ Covid-19 
  ประกอบกับช่วงเวลาที่ผ่านมาเกิดสภาวะตลาดสินค้าโภคภัณฑ์ที่มีการปรับตัวขอวราคาอย่างผันผวน จึงเป็นคำถามและหัวข้อที่เราสนใจ
...
## Next Action Plan
  - 1.
  - 2.แนวโน้มสินค้าโภคภัณฑ์ประเภทอาหารซึ่งเป็นปัจจัย4มีทิศทางสูงขึ้นเรื่อยๆ จึงมีความจำเป็นต้องหารายได้ให้มากขึ้นในอนาคตเพื่อความอยู่รอด
